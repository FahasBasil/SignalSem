...
const Products = () => {
  ...
  return (
    <div className='w-full h-[200vh]'>
      ...
      {/* product  1*/}
   <div>
        <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-rows-2  border border-gray-300 m-[20px] rounded-[10px] mb-[50px] mt-[80px] transition transform hover:scale-110 duration-500 cursor-pointer' >
      ...
      <div className='grid lg:grid-cols-2 md:grid-cols-2 border border-gray-300 m-[20px] rounded-[10px] mb-[100px] mt-[20px] transition transform hover:scale-110 duration-500 cursor-pointer'>
      <div >
  ...
  <div>
    <img className='rounded-r-[10px] h-[100%] object-cover bg-clip overflow-hidden' src={p3} alt="Magnetron Image"/>
       ...
       <div className='gridlg:grid-cols-2 md:grid-cols-2 border border-gray-300 m-[20px] rounded-[10px] mb-[100px] mt-[20px] transition transform hover:scale-110 duration-500 cursor-pointer'>
      <div >
