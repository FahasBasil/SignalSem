...
const Whatwedo = () => {
  ...
  <div className='absolute grid lg:grid-cols-2 max-sm:mt-[50px] text-white md:top-[60px]  lg:top-[110px] lg:left-[130px] md:left-[50px] md:pr-[70px] lg:pr-[100px]' ref={twoRef}>
    ...
    <div className='grid lg:grid-cols-2 md:grid-cols-3 sm:grid-cols-1 sm:mx-3 lg:grid-rows-3 md:ml-[20px] sm:gap-y-5 max-sm:mt-[100px] lg:ml-[40px] md:gap-y-5 lg:gap-y-8 md:pt-[25px]' ref={oneRef}>
  ...
  <Link to="/modules"><button className='w-full h-[100px] flex items-center px-3 text-white border border-white hover:bg-white hover:text-black bg-white bg-opacity-5 backdrop-blur backdrop-filter transition transform hover:scale-110 md:ml-[11px] duration-500'>High voltage Magnetron Driver modules</button></Link>
  ...
  <Link to="consultancy"><button className='w-full h-[100px] flex items-center px-3 text-white border border-white hover:bg-white hover:text-black bg-white bg-opacity-5 backdrop-blur backdrop-filter transition transform hover:scale-110 duration-500'>Engineering Consultancy</button></Link>
  <Link to="/stm32"><button className='w-full h-[100px] flex items-center px-3 text-white border border-white hover:bg-white hover:text-black bg-white bg-opacity-5 backdrop-blur backdrop-filter md:ml-[11px] lg:ml-[20px] transition transform hover:scale-110 duration-500'>Stm32 based projects</button></Link>
  <Link to="/metals"><button className='w-full h-[100px] flex items-center px-3 text-white border border-white hover:bg-white hover:text-black bg-white bg-opacity-5 backdrop-blur md:ml-[20px] backdrop-filter transition transform hover:scale-110 duration-500'>Bare metals and build route programming</button></Link>
</div>
